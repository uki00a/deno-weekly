...
主に[grpc-node](https://github.com/grpc/grpc-node)やNext, Eleventyなどに関連したNode.js組み込みパッケージの互換性が改善されています。
...
[@google-cloud/vision](https://github.com/googleapis/google-cloud-node/tree/main/packages/google-cloud-vision)も動作するようになったようです。
