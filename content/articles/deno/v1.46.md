...
現時点ではまだ実験的機能という扱いであり、v4を利用するには`DENO_FUTURE=1`を指定する必要があります。
...
`--unstable-hmr`が`--watch-hmr`にリネームされ、HMR機能が安定化されました。
...
- ✅ feat: Deprecate "import assertions" with a warning ([#24743](https://github.com/denoland/deno/pull/24743))
