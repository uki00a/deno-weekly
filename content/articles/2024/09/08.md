...
categories:
  - news
date: 2024-09-08
description: Deno v2.0.0-rc.1 (直近の変更内容について), Deno v1.46.3 (deno publishやdeno upgradeの改善), @std/uuid@1.0.3 (UUIDv7の実験的サポート), @std/tarの追加, Oak v17.0.0 (リクエストボディが複数回読めるように改善)
---
