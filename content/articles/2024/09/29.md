...
categories:
  - news
date: 2024-09-29
description: Deno v2.0.0-rc.{5,6,7}がリリース (--allow-importの導入など), @deno/vite-plugin (Deno公式のViteプラグイン), @types/deno, Deno 2.0 rcでreactとnext.jsの設定を試す, Slack Platform（Deno）を活用したインシデント対応標準化の取り組み, rusty_v8の安定版がリリース
---
