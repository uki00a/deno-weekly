...
date: 2024-11-10
description: >
  Deno v2.0.5 (ワークスペースメンバーのワイルドカード形式での指定がサポート, .cts形式のサポート, など), Deno v2.0.6 (Deno.serveでのRequest.signalのサポートなど), Deno v2.1で導入が検討されている機能について (deno fmtでの.sqlのサポート, Deno.tracing), denoland/kv-utils
---
...
[先週]({{< ref "articles/2024/11/03.md" >}})に続いて、Deno v2.1に入ることが検討されていると思われる機能に関していくつかPRが作成されているため、紹介します。
