...
これらを指定することにより、プラグインによってRouteやMiddlewareを注入できるようになりました。
...
[Error Boundary](https://github.com/preactjs/preact-www/blob/da0dfe3fdd4042e07a9da732686cf98273332115/content/en/tutorial/09-error-handling.md)がサポートされました。
