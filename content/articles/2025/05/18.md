...
このリリースでは、[prisma-client-js](https://github.com/prisma/prisma-client-js)から[prisma-client](https://github.com/prisma/docs/blob/efc71d366c80cfaf866e3544aded5ce3e75f4f57/content/200-orm/100-prisma-schema/10-overview/03-generators.mdx#prisma-client-early-access)ジェネレーターへの移行が行われており、DenoからPrismaを利用する際の設定方法などが変更されているようです。
