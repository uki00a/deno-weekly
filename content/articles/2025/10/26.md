...
まだ正式にこの機能が導入されるかどうかはわかりませんが、このPR内においては、Denoに`dependencies`/`devDependencies`のサポートを追加する代わりに、[Import maps 標準を拡張すること (`conditions`フィールドの追加)](https://github.com/denoland/deno/pull/31065#issuecomment-3439804634)も提案されています。
