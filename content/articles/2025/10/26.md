...
date: 2025-10-26
description: >
  typescript-goサポートがマージ, Deno Deployのアップデート (Databases - データベースマイグレーションのサポート), freshのリリース (@fresh/init@2.2.1 - `@/`形式のパスエイリアスが設定されるよう改善, @fresh/core@2.1.3 - HEADの取り扱いの改善, など)
---
