...
`allowScripts`の詳細については[先週のページ]({{< ref "articles/2025/11/09.md" >}})を参照いただければと思います。
...
AES-GCM向けに`createCipheriv()`で`authTagLength`オプションがサポートされています ([#31253](https://github.com/denoland/deno/pull/31253))
