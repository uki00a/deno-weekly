...
### Fresh v2 (`@fresh/core@2.0.0`) のリリースについて

2025/09/10 に Fresh v2 ([@fresh/core@2.0.0](https://jsr.io/@fresh/core@2.0.0))が正式にリリースされました。
...
Fresh v2 の正式リリース後も引き続き開発が進められています。

[@fresh/plugin-vite@1.0.2](https://github.com/denoland/fresh/releases/tag/2.0.2)では`.env`の読み込みがサポートされています ([#3416](https://github.com/denoland/fresh/pull/3416))。`.env`に加えて、環境に応じて追加で以下のファイルも読み込まれるようです:

- `.env.local`
- `.env.{development,production}`
- `.env.{development,production}.local`

また、Fresh v2 アプリケーションを`deno compile`できるよう、ビルド後に`_fresh/compiled-entry.js`というファイルを生成する改善も実施されています ([#3410](https://github.com/denoland/fresh/pull/3410))
