...
date: 2025-01-12
description: >
  Deno v2.1.5 (QUICサポート, deno lintのJavaScriptプラグイン向けの内部的な基盤の追加, OpenTelemetryサポートにおける@deno/otelの不要化, など), WinterTCに関するアナウンス, deno_stdのリリース (@std/fs@1.0.9 - lstatSync/statSyncの追加)
---
