...
export default {
    ...
    'outputPath': "404.html",
    'title': "",
    'content': React.createElement(NotFoundPage, { config: {
            blog: {
                root: '/articles',
                social: {
            ...
            React.createElement("meta", { content: "summary", name: "twitter:card" }),
            React.createElement("meta", { content: "@uki00a", name: "twitter:site" }),
            React.createElement("meta", { content: "@uki00a", name: "twitter:creator" })), layoutPath: "_layout.tsx", outputPath: "404.html", pagePath: "404.tsx", script: null, title: "" }),
    'head': React.createElement(React.Fragment, null,
